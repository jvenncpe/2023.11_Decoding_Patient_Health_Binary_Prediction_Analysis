...
Capstone project output from "SP901 Data Science and Machine Learning Using Python" facilitated by Project SPARTA from Development Academy of the Philippines. The course aims to equip participants with practical skills in data science and machine learning using Python libraries. Learners explore algorithm implementation and identify the most fitting analytical techniques to meet distinct business requirements.
